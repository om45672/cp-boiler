...
//     return 0LL;
// };
// auto merge = [&](Aggregate vertex_dp, Value nei_dp, int vertex, int edge) -> Aggregate {
//     return vertex_dp + max(nei_dp, 0LL);
// };
// auto finalize = [&](Aggregate vertex_dp, int vertex, int edge) -> Value {
//     return vertex_dp + 2 * a[vertex] - 1;
// };
// auto [res, edge, redge] = rerooter(adj, base, merge, finalize);